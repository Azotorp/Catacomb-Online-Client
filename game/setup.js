...
App.stage.addChild(gameObject.aboveLOSLayer);
gameObject.aboveLOSLayer.addChild(gameObject.mousePointerLayer);
...
gameObject.wallLayer.addChild(gameObject.belowLOSLayer);
gameObject.catacombLayer.addChild(gameObject.shadowOverlayLayer);
gameObject.catacombLayer.addChild(gameObject.playerLightMaskLayer);
gameObject.catacombLayer.addChild(gameObject.laserLayer);
gameObject.catacombLayer.addChild(gameObject.playerLayer);
gameObject.worldLayer.addChild(gameObject.globalLaserLayer);
gameObject.worldLayer.addChild(gameObject.yourPlayerLayer);
gameObject.worldLayer.addChild(gameObject.debugWorldHudLayer);
gameObject.worldLayer.addChild(gameObject.playerLOSMaskLayer);
...
gameObject.debugWorldHudLayer.parentLayer = gameObject.aboveLOSLayer;
